    ...
    <header className='flex flex-col gap-1 px-1 py-1 lg:flex-row lg:justify-between lg:py-2 lg:px-4 lg:gap-0 lg:items-center'>
      ...
      <nav>
        <ul className='flex flex-row justify-around lg:gap-14 lg:mr-4'>
          ...
          <li>
            <NavLink to="/login" className={({isActive}) => (isActive ? 'nav-link-active nav-link flex flex-row gap-1 items-center' : 'nav-link flex flex-row gap-1 items-center')} end><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.7} stroke="currentColor" className="size-5 ari">
