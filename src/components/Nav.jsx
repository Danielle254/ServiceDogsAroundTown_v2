    ...
    <header className='flex flex-col gap-1 px-1 py-1 sm:flex-row sm:justify-between sm:py-2 sm:px-4 sm:gap-0 sm:items-center'>
      ...
      <nav>
        <ul className='flex flex-row justify-around sm: gap-6 md:gap-14 md:mr-4'>
          ...
          <li>
            <NavLink to="/login" className={({isActive}) => (isActive ? 'nav-link-active nav-link flex flex-row gap-1 items-center' : 'nav-link flex flex-row gap-1 items-center')} end><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.7} stroke="currentColor" className="size-4 md:size-5 ari">
