...
export default function PlaceCard({place}) {
  ...
  return (
    <div className='bg-accentblue p-2 rounded shadow-sm shadow-gray-800'>  
      ...
      <div className='text-xs py-1 my-1 rounded-full w-2/5 flex flex-row  justify-center gap-2 items-center bg-red-950'>
      ...
      {showDetail && place.deniedAccess === 'true' && <p className='w-full bg-red-950 text-white border-2 border-red-900 text-xs rounded my- px-1'>{place.deniedAccessDetails}</p>
      }
