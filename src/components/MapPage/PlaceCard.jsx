  ...
  return (
    <div className='bg-accentblue p-2 rounded shadow-sm shadow-gray-800'>
      ...
      <div className='flex flex-row justify-between'>
        <div>
          <p className='text-xs mb-2'>{streetAddress}</p>
      ...
      <div className='flex flex-row justify-between'>
        ...
        <div className='text-xs py-1 mb-1 rounded-full w-2/5 flex flex-row  justify-center gap-2 items-center bg-red-900'>
        ...
        <div className='text-xs py-1 mb-1 rounded-full w-2/5 bg-yellow-700 flex flex-row justify-center gap-2 items-center'>
      ...
      <p className='text-xs bg-white text-darkblue rounded my-1 px-1'>{publicNoteSummary(place.publicNote)}</p>
