...
import servicedogphoto from '../assets/images/servicedog.png'

export default function About() {

  return (
    <div className='px-8 pb-8 flex flex-col-reverse lg:grid lg:grid-cols-9 gap-10 bg-darkblue'>
      <div className='lg:col-span-4 mt-8'>
        <img src={servicedogphoto} alt='yellow labrador retriever service dog wearing a green guide dogs for the blind vest looks up and to the right while laying down' className='w-full shadow-sm border-4 border-lightblue'/>
